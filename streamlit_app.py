...
# --- 🎨 സൈഡ് ബാർ ബട്ടൺ നിലനിർത്തിക്കൊണ്ട് ചിഹ്നങ്ങൾ കളയാനുള്ള CSS ---
st.markdown("""
    <style>
    /* 1. Fork, GitHub ചിഹ്നങ്ങൾ മാത്രം ഒഴിവാക്കാൻ */
    ...
    /* 2. ഹെഡർ ബാക്ക്ഗ്രൗണ്ട് ക്ലിയർ ആക്കുന്നു (Sidebar ഐക്കൺ കാണാൻ) */
    header {
        background-color: rgba(0,0,0,0) !important;
    }

    /* 3. താഴെയുള്ള റെഡ് ക്രൗൺ ബാഡ്ജ് ഒഴിവാക്കാൻ */
